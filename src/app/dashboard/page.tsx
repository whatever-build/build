...
export default function AiCryptoDashboard() {
  ...
  return (
    <SidebarProvider>
      <div 
        className="flex h-screen w-full bg-[#050507] overflow-hidden text-foreground font-body select-none relative"
            ...
            <div className="max-w-[1400px] mx-auto w-full flex-1 flex flex-col min-h-0">
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="space-y-3 mt-4">
                          <Button 
                            ...
                            className={cn(
                              "w-full h-14 font-black text-[0.6875rem] uppercase tracking-[0.2em] transition-all rounded-xl border relative overflow-hidden group shadow-glow",
                              isBoosterActive 
                       ...
                       {!isAiSearchConnected ? (
                         <div className="flex-1 flex flex-col items-center justify-center text-center p-4">
                           ...
                           <Button 
                             ...
                             className={cn(
                               "w-full font-black text-[0.6875rem] uppercase tracking-[0.2em] transition-all rounded-xl border relative overflow-hidden h-12 mt-6 shadow-glow",
                           ...
                           {aiSearchLogs.length > 0 && (
                             <div className="mt-8 w-full text-left font-code text-[0.5625rem] space-y-1.5 border-t border-white/5 pt-6">
                         ...
                         <div className="flex flex-col h-full space-y-4">
                            ...
                            <Button 
                              ...
                              variant="outline" 
                              className="w-full shrink-0 mt-auto border-red-500/30 text-red-500/70 hover:text-red-500 hover:bg-red-500/10 font-black text-[0.6875rem] uppercase tracking-[0.1em] transition-all h-11 hover:scale-[1.03] active:scale-95 group/disc"
                            >
                    ...
                    <div className="md:col-span-2 glass-panel p-10 rounded-3xl border-white/5 flex items-center justify-between shadow-[0_25px_50px_rgba(0,0,0,0.4)]">
                       ...
                       <Dialog>
                         <DialogTrigger asChild>
                            <Button disabled={!isOnline} className="bg-primary/10 border border-primary/20 text-primary hover:bg-primary/20 h-14 px-10 rounded-2xl font-black text-[0.6875rem] uppercase tracking-widest transition-all shadow-[0_8px_20px_rgba(173,79,230,0.2)] hover:scale-105">
                         ...
                         <DialogContent className="bg-[#0a0a0f] border-white/10 text-white max-w-md rounded-3xl">
                           ...
                           <DialogFooter>
                             <Button disabled={isSavingPayout} onClick={handleSavePayoutAddresses} className="w-full h-14 rounded-2xl bg-primary text-black font-black uppercase text-[0.6875rem] tracking-widest shadow-glow hover:scale-[1.03]">
                            ...
                            <div key={asset.id} className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 flex items-center justify-between group hover:bg-white/[0.06] hover:border-primary/30 transition-all">
                              ...
                              <div className="flex items-center gap-4">
                                <Button 
                                  ...
                                  className="h-12 px-8 rounded-2xl border-primary/20 text-primary hover:bg-primary/10 font-black text-[0.625rem] uppercase tracking-widest group/btn transition-all hover:scale-105 shadow-sm"
                                >
                            ...
                            <div className="flex flex-col gap-6 relative z-10">
                              <div className="flex items-start justify-between gap-4">
                                ...
                                <div className="flex flex-col items-end shrink-0">
                                  <div className={cn(
                                    "text-[0.5rem] font-black px-2.5 py-1 rounded-md uppercase tracking-widest border transition-all", 
                                ...
                                <div className="space-y-4 pt-5 border-t border-white/10">
                                  ...
                                  <div className="grid grid-cols-1 gap-3">
                                    {server.features?.map((feature, idx) => (
                                      <div key={idx} className="flex items-start gap-3 text-[0.5625rem] font-bold text-white/80 leading-tight">
                         ...
                         <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-10 mt-6 shrink-0">
                            {[
                              ...
                              <div key={idx} className="p-6 md:p-8 glass-panel rounded-3xl border-white/5 space-y-4 md:space-y-5 transition-all hover:border-primary/50 shadow-lg">
                                 ...
                                 <p className="text-[1.125rem] md:text-[1.25rem] font-black text-white font-code tracking-tighter uppercase truncate transition-all">{info.value}</p>
                              </div>
                            ))}
                         </div>
                       </div>
                    ...
                    <div className="glass-panel rounded-[32px] border-white/5 flex flex-col h-[280px] md:h-[350px] relative overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.6)] shrink-0">
                      ...
                      <div className="flex-1 bg-black/70 p-5 md:p-8 font-code text-[0.625rem] md:text-[0.6875rem] overflow-hidden relative">
                        ...
                        <div ref={serverLogRef} className="h-full overflow-y-auto no-scrollbar space-y-2.5 flex flex-col z-10 relative scroll-smooth">
                           ...
                           {!isOnline && (
                             <div className="text-red-500 font-bold py-4 animate-pulse uppercase tracking-widest border border-red-500/20 bg-red-500/5 px-6 rounded-xl text-center text-[0.5625rem]">
                          ...
                          <div className="flex gap-4">
                            {[75, 100, 125].map(scale => (
                              <Button 
                                ...
                                className={cn("text-[0.5625rem] uppercase font-black h-8 px-4", uiScale === scale ? "border-primary text-primary" : "border-white/10 text-gray-500")}
                              >
                                {scale}%
                              </Button>
                            ))}
                          </div>
                          <p className="text-[0.625rem] text-gray-600 uppercase tracking-widest leading-relaxed font-medium">Adjusts the global resolution of the workstation interface.</p>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           <div className="flex flex-col gap-4 p-8 rounded-[24px] border border-white/5 bg-white/[0.01] hover:bg-white/[0.04] transition-all group shadow-lg">
                              <div className="flex items-center justify-between">
                                ...
                                <Button variant="outline" size="sm" onClick={handleMemoryFlush} className="h-9 px-4 text-[0.625rem] uppercase font-black border-primary/30 text-primary hover:bg-primary/20 rounded-lg">Flush Memory</Button>
                              </div>
                           ...
                           <div className="flex flex-col gap-4 p-8 rounded-[24px] border border-red-500/15 bg-red-500/[0.01] hover:bg-red-500/[0.05] transition-all group shadow-lg">
                              <div className="flex items-center justify-between">
                                ...
                                <Button variant="outline" size="sm" onClick={clearSession} className="h-9 px-4 text-[0.625rem] uppercase font-black border-red-500/30 text-red-500 hover:bg-red-500/20 rounded-lg">Hard Reset</Button>
                              </div>
                    ...
                    <div className="relative z-10 space-y-10">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-6 border-t border-white/10">
                        <div className="space-y-5">
                          ...
                          <p className="text-[0.9375rem] text-gray-400 leading-relaxed hover:text-white/90 transition-all">
                  ...
                  <section className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-1 glass-panel rounded-[40px] p-10 border-white/5 flex flex-col items-center text-center space-y-6 shadow-2xl hover:border-primary/40 group hover:scale-[1.03] transition-all">
                      ...
                      <div>
                        ...
                        <p className="text-[0.8125rem] text-gray-500 leading-relaxed italic hover:text-gray-300 transition-all">
                        ...
                        {[
                          ...
                          <div key={i} className="flex gap-5 group/item transition-all">
                            ...
                            <div className="space-y-1.5">
                              <span className="text-[0.6875rem] font-black text-white uppercase tracking-widest group-hover/item:text-primary transition-all">{item.step}</span>
                              <p className="text-[0.6875rem] text-gray-500 leading-normal uppercase font-bold tracking-tight group-hover/item:text-gray-300 transition-all">{item.desc}</p>
                            </div>
                          </div>
                        ))}
                      </div>
              ...
              {activeTab === 'dashboard' && (
                <div className="flex gap-6 items-center justify-center pt-10 border-t border-white/5 pb-6 shrink-0 mt-auto">
                  {isInterrogating ? (
                    <Button onClick={stopInterrogation} variant="outline" className="bg-red-500/10 border-red-500/40 hover:bg-red-500/20 text-red-500 h-16 px-16 rounded-2xl font-black text-[0.875rem] uppercase tracking-[0.3em] transition-all shadow-[0_0_25px_rgba(239,68,68,0.2)] hover:scale-105">
                      <Power className="w-5 h-5 mr-3" /> STOP SCAN
                    </Button>
                  ) : (
                    <Button onClick={startInterrogation} disabled={activeBlockchains.length === 0 || isBooting || !isOnline} className={cn("h-16 px-24 rounded-2xl font-black text-[0.875rem] uppercase tracking-[0.3em] transition-all bg-gradient-to-r from-[#AD4FE6] to-[#2937A3] text-white shadow-[0_0_40px_rgba(173,79,230,0.5)] hover:opacity-95 hover:scale-[1.05] disabled:opacity-30")}>
